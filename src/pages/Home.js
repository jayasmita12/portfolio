          ...
          <div className="col-lg-10 col-12">
            <div className="mi-home-content">
              ...
              <p>
                ...
                interactive & fully responsive with web animations.
              </p>
              <ul className="mi-socialicons mi-socialicons-bordered">
                ...
                <li>
                  <a href="https://www.github.com/jayasmita12" target="_blank" rel="noopener noreferrer">
                    <FiGithub />
                  </a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/jayasmita-sahu/" target="_blank" rel="noopener noreferrer">
                    <FiLinkedin />
                  </a>
                </li>
                {/* <li>
                ...
                <li>
                  <a href="https://medium.com/@jayasmitasahu" target="_blank" rel="noopener noreferrer">
                    <AiOutlineMedium />
                  </a>
                </li>
              </ul>
